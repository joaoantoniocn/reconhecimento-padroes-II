...
% [ folder1Treino, legendaFolder1Treino, folder1Teste, legendaFolder1Teste ] =  separaBase( matriz, legenda, 5, 1, nameClasses );
% [ folder2Treino, legendaFolder2Treino, folder2Teste, legendaFolder2Teste ] =  separaBase( matriz, legenda, 5, 2, nameClasses );
% [ folder3Treino, legendaFolder3Treino, folder3Teste, legendaFolder3Teste ] =  separaBase( matriz, legenda, 5, 3, nameClasses );
% [ folder4Treino, legendaFolder4Treino, folder4Teste, legendaFolder4Teste ] =  separaBase( matriz, legenda, 5, 4, nameClasses );
% [ folder5Treino, legendaFolder5Treino, folder5Teste, legendaFolder5Teste ] =  separaBase( matriz, legenda, 5, 5, nameClasses );
% [ folder6Treino, legendaFolder6Treino, folder6Teste, legendaFolder6Teste ] =  separaBase( matriz, legenda, 5, 6, nameClasses );
% [ folder7Treino, legendaFolder7Treino, folder7Teste, legendaFolder7Teste ] =  separaBase( matriz, legenda, 5, 7, nameClasses );
% [ folder8Treino, legendaFolder8Treino, folder8Teste, legendaFolder8Teste ] =  separaBase( matriz, legenda, 5, 8, nameClasses );
% [ folder9Treino, legendaFolder9Treino, folder9Teste, legendaFolder9Teste ] =  separaBase( matriz, legenda, 5, 9, nameClasses );
[ folder10Treino, legendaFolder10Treino, folder10Teste, legendaFolder10Teste ] =  separaBase( matriz, legenda, 5, 10, nameClasses );
...
% Projetar PCA
projecaoTreino1 =  projetarPCA( folder10Treino, folder10PCA, mean(folder10Treino) );
projecaoTeste1 =  projetarPCA( folder10Teste, folder10PCA, mean(folder10Treino) );


% Calcular taxa de acerto (Com PCA)
resultado1 = classificarKNN( projecaoTeste1(:, 1:4), projecaoTreino1(:, 1:4), legendaFolder10Teste, legendaFolder10Treino );